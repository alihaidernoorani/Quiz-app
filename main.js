...
async function askQuestion(questionNumber, count) {
...
async function compareAnswer(selectedAnswer, answers, questionNumber, currentMark) {
...
const answers = [2, 2, 2, 1, 3, 1, 1, 0, 0, 1, 2, 1, 2, 1, 2, 1, 2, 1, 0, 2]; // answers index array
